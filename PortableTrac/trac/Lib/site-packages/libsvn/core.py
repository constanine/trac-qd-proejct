...
def svn_auth_get_windows_ssl_client_cert_pw_provider(*args):
  """svn_auth_get_windows_ssl_client_cert_pw_provider(apr_pool_t pool)"""
  return _core.svn_auth_get_windows_ssl_client_cert_pw_provider(*args)
