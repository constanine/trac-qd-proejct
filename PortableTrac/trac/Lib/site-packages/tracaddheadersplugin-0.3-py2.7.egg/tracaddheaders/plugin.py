...
""" Copyright (c) 2008-2011 Martin Scharrer <martin@scharrer-online.de>
    $Id: plugin.py 9844 2011-02-08 17:33:08Z martin_s $
    $HeadURL: http://trac-hacks.org/svn/addheadersplugin/0.12/tracaddheaders/plugin.py $

    This is Free Software under the GPL v3!
""" 

__url__      = ur"$URL: http://trac-hacks.org/svn/addheadersplugin/0.12/tracaddheaders/plugin.py $"[6:-2]
__author__   = ur"$Author: martin_s $"[9:-2]
__revision__ = int("0" + r"$Rev: 9844 $"[6:-2])
__date__     = r"$Date: 2011-02-09 01:33:08 +0800 (周三, 09 二月 2011) $"[7:-2]
